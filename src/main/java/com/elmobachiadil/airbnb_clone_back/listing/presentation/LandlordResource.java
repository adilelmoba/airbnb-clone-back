package com.elmobachiadil.airbnb_clone_back.listing.presentation;
...
import com.elmobachiadil.airbnb_clone_back.listing.application.dto.CreatedListingDTO;
import com.elmobachiadil.airbnb_clone_back.listing.application.dto.DisplayCardListingDTO;
import com.elmobachiadil.airbnb_clone_back.listing.application.dto.SaveListingDTO;
...
import com.elmobachiadil.airbnb_clone_back.sharedkernel.service.StatusNotification;
import com.elmobachiadil.airbnb_clone_back.user.application.UserException;
...
public class LandlordResource {
    ...
    @Autowired
    private ObjectMapper objectMapper; // Automatically inject ObjectMapper
    ...
    private static Function<MultipartFile, PictureDTO> mapMultiPartFileToPictureDTO() {
        return multipartFile -> {
            try {
                ...
                throw new UserException(String.format("Cannot process multipart file: %s", multipartFile.getOriginalFilename()));
            }
        };
    }
